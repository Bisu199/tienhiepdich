(function () {
    ...
    const PROMPT_CSS = `
        ...
        * { box-sizing: border-box; }
        ...
        .btn.primary {
            background: #1e3a5f;
            color: #ffffff;
            box-shadow: 0 1px 2px rgba(30, 58, 95, 0.2), 0 4px 10px -2px rgba(30, 58, 95, 0.3);
        }
        .btn.primary:hover { background: #e0c060; transform: translateY(-1px); }
        .btn.primary:active { transform: translateY(0); background: #f0d070; }
        .btn.ghost {
        ...
        try {
            ...
            chrome.storage.local.get(
                ...
                async function (items) {
                    ...
                    applyStrings('en'); // UI always English
    ...
    function applyTranslation(tu, translatedTemplate, fromCacheRestore) {
        ...
        try {
            // Normalize Unicode NFC để tránh double diacritics tiếng Việt
            translatedTemplate = translatedTemplate.normalize('NFC');
