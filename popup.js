document.addEventListener('DOMContentLoaded', async () => {
    ...
    const t = getT('en'); // UI always English
    ...
    if (brandName) brandName.textContent = '⚡ Tiên Hiệp Dịch Thuật';
    if (brandSub) brandSub.textContent = 'Made by Lucas & Claude';
    if (hintEl) hintEl.textContent = 'Translate this page to Vietnamese.';
